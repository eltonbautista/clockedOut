...
const App: React.FC = function App() {
  ...
  const loginHandler = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (!currUser && loginField) {
      // Conditionals used for showing login error messages
  ...
  return (
    <StyledAppContainer className="App">
      ...
      <Routes>
        ...
        <Route path='/login' element={<Login errorMessage={loginErrorMessage} localAuth={localInfo} inputFields={userLoginData} nav={navigate} stateAuth={loggedInData} submitHandler={loginHandler} />}></Route>
